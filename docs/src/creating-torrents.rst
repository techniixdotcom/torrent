...
NiiX Torrent has a simple dialog for creating torrents. You can create single-
...
NiiX Torrent supports creating torrents in any mode.
...
default value is the current NiiX Torrent version.
...
Not a torrent option, but if checked will add the torrent to NiiX Torrent and
begin seed it.
