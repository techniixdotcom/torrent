...
using NiiXTorrentBootstrapper.ViewModels;
using NiiXTorrentBootstrapper.Views;

namespace NiiXTorrentBootstrapper
{
    public sealed class NiiXBA : BootstrapperApplication
    {
        ...
        protected override void Run()
        {
            try
            {
                ...
                Engine.Log(LogLevel.Verbose, "Launching NiiX Torrent bootstrapper");
