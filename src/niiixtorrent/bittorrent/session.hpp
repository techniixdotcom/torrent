...
template<typename T>
class NiixCommandEvent : public wxCommandEvent
{
public:
    NiixCommandEvent(wxEventType commandType = wxEVT_NULL, int id = 0)
        : wxCommandEvent(commandType, id) { }

    NiixCommandEvent(const NiixCommandEvent& event)
    ...
    wxEvent* Clone() const { return new NiixCommandEvent(*this); }
...
namespace pt { namespace BitTorrent { typedef NiixCommandEvent<pt::BitTorrent::SessionStatistics> SessionStatisticsEvent; } }
namespace pt { namespace BitTorrent { typedef NiixCommandEvent<libtorrent::info_hash_t> InfoHashEvent; } }
namespace pt { namespace BitTorrent { typedef NiixCommandEvent<std::shared_ptr<libtorrent::torrent_info>> MetadataFoundEvent; } }
namespace pt { namespace BitTorrent { typedef NiixCommandEvent<pt::BitTorrent::TorrentStatistics> TorrentStatisticsEvent; } }
namespace pt { namespace BitTorrent { typedef NiixCommandEvent<std::vector<pt::BitTorrent::TorrentHandle*>> TorrentsUpdatedEvent; } }
