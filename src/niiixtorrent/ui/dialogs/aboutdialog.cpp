...
AboutDialog::AboutDialog(wxWindow* parent, wxWindowID id)
    : wxDialog(parent, id, i18n("about_niixtorrent"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE | wxRESIZE_BORDER)
{
    ...
    lv->InsertItem(lv->GetItemCount(), "NiiX Torrent");
    ...
    desc->AppendText(i18n("niixtorrent_description"));

    auto footerSizer = new wxBoxSizer(wxHORIZONTAL);
    footerSizer->Add(new wxStaticText(this, wxID_ANY, i18n("copyright_text")));
    footerSizer->AddStretchSpacer();
    footerSizer->Add(new wxHyperlinkCtrl(this, wxID_ANY, "https://torrent.niiix.net", "https://torrent.niiix.net"));
