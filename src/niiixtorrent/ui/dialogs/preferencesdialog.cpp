    ...
    m_wantsRestart(false)
{
    ...
    buttonSizer->Add(new wxHyperlinkCtrl(this, wxID_ANY, i18n("documentation"), "https://github.com/niixtorrent/niixtorrent"), 0, wxALIGN_CENTER_VERTICAL);
...
{
    std::wstring btn = i18n("restart_niixtorrent");
